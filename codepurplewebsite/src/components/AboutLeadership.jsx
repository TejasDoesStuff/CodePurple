            ...
            <div className="m-5 h-[50vh] w-[47vw] flex-shrink-0 rounded-lg mx-4 flex flex-col justify-center items-center text-xl relative">
                <div className="">
                    ...
                    <div className="text-lg border-codePurple border-2 rounded-lg flex flex-col justify-center items-center">
                        ...
                        <a className="p-4 my-6 border-codePurple border-4 rounded-full text-codePurple hover:bg-codePurple hover:text-white hover:border-white transition-all" href="/subteams">Learn more about our leads and mentors!</a>
                    </div>
                </div>
            </div>
        </div>
