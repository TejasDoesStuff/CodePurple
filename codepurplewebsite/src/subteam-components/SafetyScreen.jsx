...
function SafetyScreen() {
  return (
    <div className="w-full h-screen bg-safety flex flex-row items-center justify-center">
      <div className="w-1/2 h-screen text-black flex flex-col items-start">
      ...
      <div className="w-1/2 h-screen text-white flex flex-col items-center justify-center">
        ...
        <div className="w-full h-1/2 flex">
          <img src={temp} alt="Small 1" className="w-1/2 h-full object-cover border-l-4 border-black" />
